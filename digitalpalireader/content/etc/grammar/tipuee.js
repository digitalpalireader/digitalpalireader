...
var results_location = 'resultse.html';
var include_num = 0;
var include_url = 0;
var bold_query = 1;
var bold_title = 0;
...
function tip_header()
{
	if (co > 0)
	{
		...
		if (bold_header == 1) document.write('<font color="blue">', od, '</font><hr>'); else document.write(od, '<hr>');
	}
}
	...
	for (var a = tn; a < nd; a++)
	{
		...
		if (bold_query == 1 && tm == 0)
		{
			for (var i = 0; i < wtr.length; i++)
			{
				...
				if (rn >= 0)
				{
					var o1 = os[5].slice(0, rn);
					var o2 = os[5].slice(rn, rn + lw);
					var o3 = os[5].slice(rn + lw);
				os[5] = o1 + '<font color="blue">' + o2 + '</font>' + o3;				}
			}
		}
		...
		document.write('<table width="100%"><tr><td><font size="4">', os[1], '</font> (', os[4], '): ', os[5],'</td><td align="right">')
