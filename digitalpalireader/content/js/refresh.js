function refreshit()
{
  ...
  $('#mafbc').html('<div id="mafrefresh" align=center><p class="huge" style="margin-bottom:10px;">Welcome&nbsp;to&nbsp;the&nbsp;Digital&nbsp;Pali&nbsp;Reader&nbsp;'+version+(news?' <span class="tiny green pointer" onclick="$(\'#newsc\').toggle(\'fast\')">NEW!</span><div class="tiny" id="newsc" style="margin:auto;text-align:left;display:none"><div align="center">What\'s&nbsp;new:</div><ul id="news"><li>'+news.join('</li><li>').replace(/ /g,'&nbsp;')+'</li></ul></div>':'')+'<p>To&nbsp;start,&nbsp;simply&nbsp;choose&nbsp;a&nbsp;set,&nbsp;book&nbsp;and&nbsp;section&nbsp;in&nbsp;<a href="javascript:void(0)" onclick="openDPRSidebar()" class="green"><b>the&nbsp;sidebar</b></a>.</p><p>For&nbsp;detailed&nbsp;instructions,&nbsp;click&nbsp;<b><a class="green" href="javascript:void(0)" onclick="openDPRTab(DPR_PAL.toWebUrl(\'chrome://digitalpalireader/content/help.htm\'),\'DPR-help\',1);">here&nbsp;for&nbsp;the&nbsp;help&nbsp;page</a></b>.</p><p>For&nbsp;information&nbsp;on&nbsp;updates,&nbsp;visit&nbsp;<b><a class="green" href="http://pali.sirimangalo.org/" target="_blank" >the&nbsp;project&nbsp;site</a></b>.</p><p>If&nbsp;you&nbsp;have&nbsp;questions&nbsp;or&nbsp;feedback,&nbsp;please<br/>contact me at <b><a class="green" href="mailto:yuttadhammo@gmail.com" target="_blank">yuttadhammo@gmail.com</a></b></p></div><div id="mafd" align=center></div><div id="mafe" align=center></div>');
