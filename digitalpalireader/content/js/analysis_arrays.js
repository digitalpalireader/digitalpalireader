...
G_indeclinableEnding[".msuudha"] = [[['su','su'],['dha','idha']],['.m','.m']];
G_indeclinableEnding["~nhi"] = [[['hi','hi']],['.m','~n']];
G_indeclinableEnding["va"] = [[['va','va']]];
G_indeclinableEnding["~n~neva"] = [[['~n','~n'],['eva','eva']],['.m','~n']];
G_indeclinableEnding["~n~neveko"] = [[['~n','~n'],['ev','eva'],['eko','eka']],['.m','~n']];
G_indeclinableEnding["~n~nevettha"] = [[['~n','~n'],['ev','eva'],['ettha','ettha']],['.m','~n']];
G_indeclinableEnding["eva"] = [[['eva','eva']]];
G_indeclinableEnding["idha"] = [[['idha','idha']]];
G_indeclinableEnding["yeva"] = [[['y','y'],['eva','eva']]];
...
G_indeclinableEnding["~ncideva"] = [[['ci','ci'],['d','d'],['eva','eva']],['.m','~n']];
G_indeclinableEnding["~ncida.m"] = [[['c','ca'],['ida.m','aya.m']],['.m','~n']];
G_indeclinableEnding["~nceta.m"] = [[['c','ca'],['eta.m','aya.m']],['.m','~n']];
...
G_indeclinableEnding["yime"] = [[['y','y'],['ime','aya.m']]];
