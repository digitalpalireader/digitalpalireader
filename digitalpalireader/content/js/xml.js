...
function loadXMLindex(place,compare) {
	...
	if(!compare) {
		...
		mainWindow.gBrowser.selectedTab.linkedBrowser.contentWindow.history.replaceState({}, 'Title', permalink+'loc='+place.slice(0,8).join('.'));
		setCurrentTitle(tabT);
	}
