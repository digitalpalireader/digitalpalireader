...
function loadXMLSection(querystring,para,place,isPL,scroll,compare)
{
  ...
  if(hier == 'm') {
    ...
    var modt =   (modno ? ' (<b class="small" style="color:'+DPR_prefs['colsel']+'">' + DPR_G.G_nikLongName[nikaya] + (hier == 'm' ? '' : '-'+hier) + '&nbsp;' + modno + '</b>)' : '');
  }
