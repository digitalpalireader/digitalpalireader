...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\digitalpalireader on
     Windows, /home/user/dev/digitalpalireader on Linux) in a file named
     digitalpalireader@noah.yuttadhammo and copy that file to
