...
{
	document.getElementById('mafbc').innerHTML='<div id="mafrefresh" align=center><h1>Welcome&nbsp;to&nbsp;the&nbsp;Digital&nbsp;Pali&nbsp;Reader&nbsp;'+version+'</h1><p>To&nbsp;start,&nbsp;simply&nbsp;choose&nbsp;a&nbsp;book,&nbsp;section&nbsp;and&nbsp;passage&nbsp;on&nbsp;the&nbsp;right&nbsp;side&nbsp;of&nbsp;the&nbsp;screen.</p><p>For&nbsp;detailed&nbsp;instructions,&nbsp;click&nbsp;<b><a style="color:blue" href="javascript:void(0)" onclick="helpXML()">here&nbsp;for&nbsp;the&nbsp;help&nbsp;page</a></b>.</p><p>For&nbsp;information&nbsp;on&nbsp;updates,&nbsp;visit&nbsp;<b><a href="http://pali.sirimangalo.org/" target="_blank" style="color:blue">the&nbsp;project&nbsp;site</a></b>.</p><p>If&nbsp;you&nbsp;have&nbsp;questions&nbsp;or&nbsp;feedback,&nbsp;you&nbsp;can&nbsp;try&nbsp;to&nbsp;contact&nbsp;me&nbsp;at&nbsp;<b><a style="color:blue" href="mailto:yuttadhammo@gmail.com">yuttadhammo@gmail.com</a></b></p></div><div id="mafd" align=center></div><div id="mafe" align=center></div>';
